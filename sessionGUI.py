...
class SDFCreator(wx.Frame):
	...
	def onVolume(self, event):
		...
		VolumeInfo(self, -1, 'Estimated Data Volue')
...
class VolumeInfo(wx.Dialog):
	def __init__ (self, parent, ID, title):
		nObs = len(parent.project.sessions[0].observations)
		
		wx.Dialog.__init__(self, parent, ID, 'Estimated Data Volume', size=(360, 370))
	...
	def initUI(self):
		...
		dataText = wx.StaticText(self, -1, 'Estimated Data Volume:')
